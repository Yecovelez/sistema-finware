docker exec -i sistema-finware-web-1 tee /var/www/html/views/clientes.php << 'EOF'
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
                        ...
                        <form method="POST" action="index.php?action=guardarCliente">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-start-0" id="nuevoDocumento" name="nuevoDocumento" placeholder="Ej: 10234567" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control border-start-0" id="nuevoNombre" name="nuevoNombre" placeholder="Ej: Juan Pérez" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-end-0 text-primary"><i class="fas fa-phone"></i></span>
                                    <input type="text" class="form-control border-start-0" id="nuevoTelefono" name="nuevoTelefono" placeholder="Ej: 3001234567">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-end-0 text-primary"><i class="fas fa-envelope"></i></span>
                                    <input type="email" class="form-control border-start-0" id="nuevoEmail" name="nuevoEmail" placeholder="Ej: cliente@correo.com">
                                </div>
                            </div>
